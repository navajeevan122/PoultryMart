...
const popularBreedsList = [
  ...
  { name: 'Cross Naatu Kodi', desc: 'High Egg Yield Country Layer', icon: '🍳', badge: 'Egg Layer' },
];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
              ...
              <p className="text-lg text-emerald-100/90 font-normal leading-relaxed max-w-2xl mx-auto lg:mx-0">
                Find organic free-range Naatu Kollu (Natu Kodi), Peruvidai, Siruvidai, and Kili Mookku Aseel country hens and roosters directly from local farmers. Zero middleman fees!
              </p>
              ...
              <form onSubmit={handleHeroSearchSubmit} className="relative max-w-xl mx-auto lg:mx-0">
                <div className="relative flex items-center bg-white rounded-2xl p-2 shadow-2xl border border-white/20">
                  ...
                  <input
                    ...
                    placeholder="Search Naatu Kollu, Peruvidai, Kili Mookku, West Godavari..."
                ...
                <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-inner">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-slate-950/90 via-transparent to-transparent flex items-end p-6">
                    <div className="text-white space-y-1">
                      ...
                      <p className="text-xs text-emerald-200">West Godavari, Visakhapatnam & South India</p>
                    </div>
                  </div>
                </div>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1">
              Recently approved organic country hens, Peruvidai roosters, and native breeding stock.
            </p>
          </div>
          <Link
            to="/browse"
